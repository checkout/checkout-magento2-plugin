...
## Webhook URL
In order to allow the Checkout.com payment gateway to send payment notifications to your Magenot 2 installation, you will have to configure the following URL as a Webhook URL in the Hub:
