...
define([
    ...
    return {
        ...
        getValue: function (methodId, field) {
            ...
            if (
                methodId &&
                Config.hasOwnProperty(methodId) &&
                Config[methodId].hasOwnProperty(field)
            ) {
                val = Config[methodId][field];
            } else if (
                Config.hasOwnProperty(KEY_CONFIG) &&
                Config[KEY_CONFIG].hasOwnProperty(field)
            ) {
        ...
        getShopLanguage() {
            ...
            switch (mageShopLanguage) {
                ...
                case "es_ES":
                    ...
                    break;
                default:
                    framesLanguage = this.getLangageFallback()
                        .toUpperCase()
                        .split("_")
                        .join("-");
            }
        ...
        showMessage: function (type, message, methodId) {
            ...
            var messageContainer = this.getMethodContainer(methodId).find(
                ".message"
            );
