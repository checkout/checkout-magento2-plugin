...
{
    const EDIT_URL = 'checkout_com/subscription/addrow';

    const LIST_URL = 'checkout_com/subscription/index';

    const MODEL_CLASS = '\CheckoutCom\Magento2\Model\Subscription';
