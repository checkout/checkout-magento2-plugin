 ...
 * list). Reuses all of FlowMethod's capture/void/refund logic; only the payment method code
 * differs so Magento treats it as a separate method.
 */
class PaypalFlowMethod extends FlowMethod
{
    /**
     * CODE constant
     *
     * @var string CODE
     */
    public const CODE = 'checkoutcom_flow_paypal';
